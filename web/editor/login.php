...
<? include "outsideheader.php"; ?>
        ...
        <div class="content">
            ...
            <form action="./common/controller.php" method="POST">
                ...
                <table>
                    <tr>
                        <td>Email:<br /><input type="text" name="email" class="myinput" /></td>
                    </tr>
                    <tr>
                        <td><br />Password:<br /><input type="password" name="password" size="15" class="myinput" /></td>
                    </tr>
                    <tr>
                ...
                <a style="font-size: smaller;" href="../register.php">Register</a>
            </form>
